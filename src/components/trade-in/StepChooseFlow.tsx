        ...
        {cards.map((c) => {
          ...
          return (
            <button
              ...
              className={`group relative text-left w-full rounded-2xl border-2 border-border bg-gradient-to-br ${c.accent} p-5 md:p-6 transition-all hover:shadow-md hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-primary/40`}
            >
              <div className="flex items-start gap-4">
                <div
                  className={`flex-shrink-0 h-12 w-12 md:h-14 md:w-14 rounded-2xl ${c.iconBg} flex items-center justify-center`}
                >
